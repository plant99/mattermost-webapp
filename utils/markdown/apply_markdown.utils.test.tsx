import { applyMarkdown } from "./apply_markdown.utils";
...
describe("applyMarkdown", () => {
    ...
    test("should add ordered list to selected newline", () => {
        ...
        const result = applyMarkdown({value, selectionStart: 5, selectionEnd: 6, markdownMode:'ol'})
    ...
    test("should add ordered list", () => {
        const value = "brown\nfox jumps over lazy dog";
        const result = applyMarkdown({value, selectionStart: 0, selectionEnd: 10, markdownMode:'ol'})
    ...
    test("should remove ordered list", () => {
        const value = "0. brown\n1. fox jumps over lazy dog";
        const result = applyMarkdown({value, selectionStart: 0, selectionEnd: 0, markdownMode:'ol'})
    ...
    test("should remove ordered list", () => {
        // '0. brown\n2. f'
        const value = "0. brown\n1. fox jumps over lazy dog";
        const result = applyMarkdown({value, selectionStart: 0, selectionEnd: 13, markdownMode:'ol'})
    ...
    test("should apply unordered list", () => {
        ...
        const result = applyMarkdown({value, selectionStart: 0, selectionEnd: 0, markdownMode:'ul'})
